...
public class RequestHeaderPrintServlet extends HttpServlet {
    ...
    * 3. Response header
    *       위치나 서버 자체와 같은 응답헤 대한 부가적인 정보를 갖는 헤더
    * 4. Entity header
    *       컨텐츠의 길이나 MIME 타입과 같은 엔티티 body에 대한 상세 정보를 포함하는 헤더
    ...
    * */
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("accept_language : " + request.getHeader("accept_language"));
        ...
        // upgrade-insecure-request : 클라이언트가 서버한테 http -> https 로 업그레이드를 요청할 때 사용
