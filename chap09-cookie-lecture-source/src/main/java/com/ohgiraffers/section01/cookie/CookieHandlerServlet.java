...
//        response.sendRedirect("redirect");
        ...
        * */
        ...
        // cookie는 기본 생성자를 제공하지 않는다.
        Cookie fristNameCookie = new Cookie("firstName", firstName);
        Cookie lastNameCookie = new Cookie("lastName", lastName);

        // 초 단위 설정 (만료시간을 하루로 둔다.)
        fristNameCookie.setMaxAge(60 * 60 * 24);
        lastNameCookie.setMaxAge(60 * 60 * 24);

        // response에 쿠키 담기
        response.addCookie(fristNameCookie);
